...
export class AddUsersArticlesFavoritesRelation1666429322369
  implements MigrationInterface
{
  name = 'AddUsersArticlesFavoritesRelation1666429322369';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "users_favorites_articles" ("usersId" character varying NOT NULL, "articlesId" character varying NOT NULL, CONSTRAINT "PK_aebb5070a5fa58957adae6d78af" PRIMARY KEY ("usersId", "articlesId"))`,
    );
    await queryRunner.query(
